package practices.my.countstep.Views;
...
public class MyLineChartView extends LineChartView {
    ...
    public MyLineChartView(Context context, List<Point> points) {
        this(context, points, new LineChartStyle());
    }

    public MyLineChartView(Context context, List<Point> points, LineChartStyle lineChartStyle) {
        super(context, points, lineChartStyle);
    }

    public MyLineChartView(Context context, LineChartStyle lineChartStyle) {
